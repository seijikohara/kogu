...
` + e.stack) : e;
	...
	var gn = class oo {
		...
		static #e = this.Undefined = new on(void 0);
		constructor(t) {
...
`));
	...
	var kn = class St {
		...
		static #n = this._locales = new yn(() => Object.keys(St.ambiguousCharacterData.value).filter((t) => !t.startsWith("_")));
		static getLocales() {
	...
	(class Pe {
		static #e = this.Comment = new Pe("comment");
		static #t = this.Imports = new Pe("imports");
		static #n = this.Region = new Pe("region");
		static fromValue(t) {
			switch (t) {
...
` || e === "	";
	...
	var ys = class go {
		...
		static #e = this.compareByStart = ft((t) => t.startLineNumber, pt);
		static joinMany(t) {
...
`), i = al(n, r), s = Vn.ofText(n.substring(0, n.length - i)).addToPosition(this.range.getStartPosition()), a = r.substring(0, r.length - i);
	...
	var nt = class Si {
		...
		static #e = this.zero = new dn(0, 0);
		static #t = this.max = new dn(Number.MAX_SAFE_INTEGER, Number.MAX_SAFE_INTEGER);
		constructor(t, n) {
...
`);
	...
	var x = class {
		...
		static #e = this.white = new ne(new x(255, 255, 255, 1));
		static #t = this.black = new ne(new x(0, 0, 0, 1));
		static #n = this.red = new ne(new x(255, 0, 0, 1));
		static #i = this.blue = new ne(new x(0, 0, 255, 1));
		static #r = this.green = new ne(new x(0, 255, 0, 1));
		static #s = this.cyan = new ne(new x(0, 255, 255, 1));
		static #a = this.lightgrey = new ne(new x(211, 211, 211, 1));
		static #o = this.transparent = new ne(new x(0, 0, 0, 0));
	};
	(function(e) {
		(function(t) {
			(function(n) {
	...
	function lh(e) {
		const t = [], n = wt(e, new RegExp(`\\b(rgb|rgba|hsl|hsla)(\\([0-9\\s,.\\%]*\\))|^(#)([A-Fa-f0-9]{3})\\b|^(#)([A-Fa-f0-9]{4})\\b|^(#)([A-Fa-f0-9]{6})\\b|^(#)([A-Fa-f0-9]{8})\\b|(?<=['"\\s])(#)([A-Fa-f0-9]{3})\\b|(?<=['"\\s])(#)([A-Fa-f0-9]{4})\\b|(?<=['"\\s])(#)([A-Fa-f0-9]{6})\\b|(?<=['"\\s])(#)([A-Fa-f0-9]{8})\\b`, "gm"));
...
`) + 1, k = u.index - T + 1, E = b[b.length - 1], I = {
	...
	(class we {
		...
		static #e = this.EMPTY = we.fromArray([]);
		static map(t, n) {
