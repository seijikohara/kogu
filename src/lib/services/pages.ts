...
export const PAGES: readonly PageDefinition[] = [
	...
	},
	{
		...
		title: 'Folder Tree',
		url: '/folder-tree-visualizer',
		icon: FolderTree,
		description:
			'Recursive folder tree with cumulative sizes, glob filter, and largest-file finder',
		color: 'text-amber-600',
		category: 'files',
	},
	{
	...
	},
	{
		...
		icon: Copy,
		description: 'Scan a folder for duplicate files (size + partial hash + full hash)',
		color: 'text-amber-500',
		category: 'files',
	},
	{
		...
		description: 'View mounted drives with capacity, free space, and usage percentage',
		color: 'text-amber-500',
		category: 'files',
	},
	{
