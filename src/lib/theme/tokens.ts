...
export const COLOR = {
	light: {
		...
		popover: 'oklch(1 0 0)',
		popoverForeground: 'oklch(0.3 0 0)',
	...
	dark: {
		...
		accentForeground: 'oklch(0.84 0 0)',
		...
		sidebarAccentForeground: 'oklch(0.84 0 0)',
		sidebarBorder: 'oklch(1 0 0 / 12%)',
		sidebarRing: 'oklch(0.556 0 0)',
		surface0: 'oklch(0.193 0 0)',
		surface1: 'oklch(0.165 0 0)',
		surface2: 'oklch(0.165 0 0)',
		surface3: 'oklch(0.13 0 0)',
		surface4: 'oklch(0.11 0 0)',
		panel: 'oklch(0.2 0.02 260)',
		accentSoft: 'oklch(0.25 0.025 260)',
		accentBrand: 'oklch(0.65 0.2 265)',
